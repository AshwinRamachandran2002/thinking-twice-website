...
const SECURITY_LOGS_PATH = '/home/ashwin/Desktop/thinking-twice-website/server/contextfort-demo-local/contextfort_logs/security_decisions';

// Interface for security decision log
...
export class SecurityDashboard {
    ...
    private securityLogs: SecurityDecision[] = [];
    ...
    private setupFileWatcher() {
        ...
        this.fileWatcher = vscode.workspace.createFileSystemWatcher(
            new vscode.RelativePattern(SECURITY_LOGS_PATH, '*.json')
        );
    ...
    private loadSecurityLogs() {
        try {
            ...
            this.securityLogs = recentFiles.map(file => {
                ...
                return JSON.parse(content) as SecurityDecision;
            });
