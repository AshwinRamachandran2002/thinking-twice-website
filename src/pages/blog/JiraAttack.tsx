              ...
              <div className="bg-white rounded-3xl shadow-xl overflow-hidden">
                ...
                <div className="bg-gradient-to-r from-[#ffa62b]/90 to-[#ff7b2b]/90 px-6 md:px-10 py-12 text-white">
                  ...
                  <h1 className="text-4xl md:text-5xl font-extrabold mb-6 leading-tight">
                    Exposing the Jira Atlassian MCP Server Attack Vector
                  </h1>
                ...
                <div className="p-6 md:p-10">
                  ...
                  <section data-section="attack-scenario" className="mb-16">
                    ...
                    <div className="relative bg-gray-50 rounded-2xl overflow-hidden border border-gray-100 mb-10">
                      <div className="relative aspect-[16/9] overflow-hidden">
                        {/* Current image */}
                        <img 
                          src={`/images/jira-attack/${activeImageIndex + 1}.png`} 
                      ...
                      <div className="p-6">
                        ...
                        <div className="text-base text-slate-700">
                          {activeImageIndex === 0 && (
                            <p>User has two Jira projects: "Ongoing" (accessible to multiple team members) and "TOP SECRET" (highly restricted access)</p>
                          )}
                          {activeImageIndex === 1 && (
                            <p>The "Ongoing" project has a TODO assigned to the Attacker, giving them legitimate access to this project</p>
                          )}
                          {activeImageIndex === 2 && (
                            <p>The Attacker's goal is to exfiltrate information from the "TOP SECRET" project, which they don't have access to</p>
                          )}
                          {activeImageIndex === 3 && (
                            <p>The sensitive tasks in "TOP SECRET" contain valuable feature and client information</p>
                          )}
                          {activeImageIndex === 4 && (
                            <p>The Attacker adds a malicious comment with a prompt injection to their task in the "Ongoing" project</p>
                          )}
                          {activeImageIndex === 5 && (
                            <p>A legitimate user prompts GitHub Copilot (with Claude Sonnet 3.7) to obtain a summary of tasks in the "Ongoing" project</p>
                          )}
                          {activeImageIndex === 6 && (
                            <p>Claude fetches the latest comments from the "Ongoing" project, including the malicious prompt injection</p>
                          )}
                          {activeImageIndex === 7 && (
                            <p>Claude is manipulated to access and send information from the "TOP SECRET" project</p>
                          )}
                          {activeImageIndex === 8 && (
                            <p>A comment containing the leaked sensitive information is added to the "Ongoing" project, visible to the Attacker</p>
                          )}
                        </div>
                      </div>
                    </div>
                  ...
                  <section data-section="concerns" className="mb-16">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 mb-8">
                      <div className="bg-white shadow-sm rounded-xl border border-gray-100 p-6 hover:shadow-md transition-shadow">
                        ...
                        <p className="text-slate-700">The attacker was able to access information they shouldn't have permission to view, bypassing security boundaries.</p>
                      </div>
                      ...
                      <div className="bg-white shadow-sm rounded-xl border border-gray-100 p-6 hover:shadow-md transition-shadow">
                        ...
                        <p className="text-slate-700">The malicious prompt was delivered through a legitimate communication channel (Jira comments).</p>
                      </div>
                      ...
                      <div className="bg-white shadow-sm rounded-xl border border-gray-100 p-6 hover:shadow-md transition-shadow">
                        ...
                        <p className="text-slate-700">Sensitive information was leaked to an unauthorized user through a legitimate communication channel.</p>
                      </div>
                    </div>
                  </section>
                  ...
                  <section data-section="real-world" className="mb-16">
                    ...
                    <p className="mb-6 text-slate-700 leading-relaxed text-lg">
                      While this demonstration was performed in a controlled environment, similar attacks can happen in real-world organizations that integrate AI assistants with their collaboration tools.
                    </p>
                      ...
                      <ol className="space-y-6">
                        <li className="flex">
                          ...
                          <div>
                            ...
                            <p className="text-slate-700">An attacker gains legitimate access to a shared project, perhaps as a contractor or through a compromised account.</p>
                          </div>
                        </li>
                        <li className="flex">
                          ...
                          <div>
                            ...
                            <p className="text-slate-700">The attacker identifies that the organization uses AI assistants integrated with their project management tools.</p>
                          </div>
                        </li>
                        <li className="flex">
                          ...
                          <div>
                            ...
                            <p className="text-slate-700">The attacker plants malicious prompts in seemingly benign comments, bug reports, or task descriptions.</p>
                          </div>
                        </li>
                        <li className="flex">
                          ...
                          <div>
                            ...
                            <p className="text-slate-700">When a legitimate user asks the AI assistant for help with the project, the assistant processes the malicious prompts.</p>
                          </div>
                        </li>
                        <li className="flex">
                          ...
                          <div>
                            ...
                            <p className="text-slate-700">The AI is manipulated to access sensitive information from restricted projects and share it back in a location accessible to the attacker.</p>
                          </div>
                        </li>
                      </ol>
                    </div>
