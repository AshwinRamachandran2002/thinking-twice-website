        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl w-full">
            ...
            >
              ...
              <h3 className="text-xl font-bold mb-2 text-center" style={{ color: '#ffa62b' }}>Try our Automated Red Teaming tool</h3>
              ...
              <div className="flex justify-center">
                ...
                >
                  ...
                  <span className="relative z-10 no-underline">Try Red Teaming tool</span>
